...
.data
	...
	stCountFont LOGFONT <14,0,0,0,FW_EXTRABOLD,0,0,0,DEFAULT_CHARSET,OUT_TT_PRECIS,0,0,0,"Tahoma">
...
DlgProc		proc	hWnd:HWND, uMsg:UINT, wParam:WPARAM, lParam:LPARAM
	.if uMsg == WM_INITDIALOG
		...
		invoke SendDlgItemMessage, hWnd, IDC_EXIT, WM_SETFONT, eax, TRUE
		;invoke SendDlgItemMessage, hWnd,IDC_EXIT,B
